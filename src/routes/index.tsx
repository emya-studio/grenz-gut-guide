  ...
  head: () => ({
    meta: [
      { title: "Grenz | دمنوش آرامش گوارشی" },
      {
        name: "description",
        content:
          "Grenz؛ دمنوش سلامت‌محور برای همراهی در روتین آرامش گوارشی. راهنمای انتخاب محصول مناسب بر اساس وضعیت گوارشی شما.",
      },
    ],
  }),
});
...
const PRODUCTS: Record<
  ConditionKey,
  { name: string; tagline: string; bullets: string[]; price: string }
> = {
  crohn: {
    name: "Grenz Crohn Calm",
    tagline: "همراه روتین آرامش برای حساسیت‌های گوارشی پیچیده",
    bullets: ["ترکیب گیاهی ملایم", "بدون افزودنی شیمیایی", "مناسب مصرف روزانه"],
    price: "۲۸۵٬۰۰۰ تومان",
  },
  uc: {
    name: "Grenz UC Balance",
    tagline: "دمنوش متعادل‌کننده برای سبک زندگی آرام‌تر",
    bullets: ["گیاهان منتخب آرام‌بخش", "بسته‌بندی بهداشتی", "طعم ملایم"],
    price: "۲۹۵٬۰۰۰ تومان",
  },
  ibsd: {
    name: "Grenz IBS-D Comfort",
    tagline: "همراه آرامش برای روزهای حساس روده",
    bullets: ["ترکیب ملایم گوارشی", "کمک به حس راحتی", "مصرف ساده"],
    price: "۲۶۵٬۰۰۰ تومان",
  },
  ibscm: {
    name: "Grenz IBS-C/M Relief",
    tagline: "همراه روزانه برای الگوی ترکیبی یا یبوست",
    bullets: ["گیاهان فیبرمحور", "حس سبکی روزانه", "بدون شیرینی افزوده"],
    price: "۲۶۵٬۰۰۰ تومان",
  },
  daily: {
    name: "Grenz Daily Gut Calm",
    tagline: "دمنوش روزانه برای آرامش عمومی گوارش",
    bullets: ["مناسب مصرف هر روز", "ملایم و بی‌خطر برای روتین", "طعم لطیف"],
    price: "۲۴۵٬۰۰۰ تومان",
  },
};
...
const CONDITION_CARDS: { key: ConditionKey; title: string; line: string; Icon: any }[] = [
  {
    key: "crohn",
    title: "کرون (Crohn)",
    line: "همراه روتین برای حساسیت‌های گوارشی مزمن",
    Icon: Activity,
  },
  {
    key: "uc",
    title: "کولیت اولسراتیو (UC)",
    line: "همراهی در سبک زندگی آرام‌تر گوارشی",
    Icon: ShieldCheck,
  },
  {
    key: "ibsd",
    title: "IBS-D (اسهال غالب)",
    line: "روزهای حساس روده با الگوی اسهال",
    Icon: Droplets,
  },
...
function Index() {
  ...
  const computeFromAnswers = (a: Record<number, string>): ConditionKey => {
    ...
    if (a[1] === "بیشتر یبوست" || a[1] === "ترکیبی از اسهال و یبوست" || a[3]?.includes("یبوست"))
      return "ibscm";
    return "daily";
  };
  ...
  const submitQuestionnaire = () => {
    ...
    if (!valid) {
      setPhoneError("لطفا شماره تماس معتبر وارد کنید.");
      return;
    }
    setPhoneError("");
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="bg-gradient-hero pt-24 pb-12 px-5">
        <div className="mx-auto max-w-3xl text-center">
          <div className="mx-auto mb-7 w-full max-w-sm aspect-square rounded-3xl bg-white shadow-soft overflow-hidden flex items-center justify-center custom-image-hero">
            <img
              src={heroImg}
              alt="بسته‌بندی دمنوش Grenz"
              width={1024}
              height={1024}
          ...
          <p className="mt-5 text-base sm:text-lg leading-8 text-muted-foreground text-justify">
            Grenz یک دمنوش سلامت‌محور برای افرادی است که به دنبال آرامش بیشتر در روتین گوارشی خود
            هستند. با تجربه‌ای ساده، طبیعی و قابل اعتماد، به شما کمک می‌کند انتخاب مناسب‌تری برای
            شرایط بدنی خود داشته باشید. ابتدا وضعیت گوارشی خود را انتخاب کنید تا محصول پیشنهادی
            مخصوص شما نمایش داده شود.
          </p>
          <button
      ...
      <section id="guide" ref={guideSectionRef} className="px-5 py-14 bg-white">
        <div className="mx-auto max-w-4xl">
          <SectionTitle
            kicker=" "
            title="نوع IBD خود را انتخاب کنید"
            ...
            {CONDITION_CARDS.map(({ key, title, line, Icon }) => {
              ...
              return (
                <button
                  ...
                  className={`text-right rounded-2xl border p-2 transition shadow-card hover:shadow-soft hover:-translate-y-0.5 ${
                ...
                >
                  ...
                  <span className="mt-4 block w-full rounded-xl bg-primary text-primary-foreground py-2.5 text-sm font-semibold text-center">
                    انتخاب
                  </span>
                </button>
              );
          ...
          <div className="mt-5">
            ...
            >
              <span className="flex items-center gap-2">
                <HelpCircle className="w-5 h-5" /> نمی‌دانم — به من کمک کن
              </span>
              <ChevronDown
                className={`w-5 h-5 transition ${showQuestionnaire ? "rotate-180" : ""}`}
              />
            </button>
        ...
        {!isUnlocked && (
          <div className="absolute inset-0 z-20 flex items-start justify-center pt-16 px-5 pointer-events-none">
            <div className="rounded-2xl bg-white border border-border shadow-soft px-5 py-4 max-w-md text-center pointer-events-auto">
              ...
              <button
                onClick={scrollToGuide}
                className="mt-3 rounded-xl bg-primary text-primary-foreground px-4 py-2 text-sm font-semibold"
              >
                رفتن به راهنما
              </button>
            </div>
        ...
        <div className={isUnlocked ? "" : "locked-blur"}>
          ...
          <section id="products" ref={productSectionRef} className="px-5 py-14 bg-secondary/40">
            <div className="mx-auto max-w-4xl">
              <SectionTitle
                kicker=" "
                title="محصول پیشنهادی شما"
                desc={
                  recommended
                    ? "بر اساس انتخاب شما، این محصول برای همراهی با روتین گوارشی‌تان پیشنهاد می‌شود."
                    : "پس از انتخاب وضعیت، محصول پیشنهادی شما اینجا نمایش داده می‌شود."
                }
              />
                ...
                <div className="mt-8 rounded-3xl bg-white border border-border shadow-soft overflow-hidden fade-in">
                  <div className="grid md:grid-cols-2">
                    ...
                    <div className="p-6 sm:p-8">
                      <span className="inline-block text-xs rounded-full bg-secondary text-primary-deep px-3 py-1">
                        پیشنهاد ویژه شما
                      </span>
                      ...
                      <div className="mt-5 flex flex-col sm:flex-row gap-3">
                        <button
                          onClick={() => addToCart(selectedCondition!)}
                ...
                <div className="flex gap-4 overflow-x-auto pb-3 -mx-5 px-5 snap-x">
                  {(Object.keys(PRODUCTS) as ConditionKey[]).map((key) => {
                    ...
                    return (
                      <div
                        key={key}
                        className={`snap-start flex-shrink-0 w-64 rounded-2xl border bg-white p-4 ${enabled ? "border-primary shadow-card" : "border-border opacity-70"}`}
                      >
                        <img
                          src={productImg}
                          alt={p.name}
                        ...
                        {enabled ? (
                          <button
                            ...
                            className="mt-3 w-full rounded-xl bg-primary text-primary-foreground py-2 text-sm font-semibold"
                          >
                            افزودن به سبد
                          </button>
                        ) : (
      ...
      <StickyCTA
        ...
        onBuy={() => {
          if (selectedCondition) addToCart(selectedCondition);
          scrollToProduct();
        }}
      />
      <div className="h-24" />
...
function Header({ scrolled, menuOpen, setMenuOpen, cartCount }: any) {
  ...
  return (
    <header
      id="top"
      className={`fixed top-0 inset-x-0 z-40 transition ${scrolled ? "bg-white/85 backdrop-blur shadow-card" : "bg-white/60 backdrop-blur-sm"}`}
    >
      <div className="mx-auto max-w-5xl flex items-center justify-between px-5 h-16">
        ...
        <a href="#top" className="flex items-center gap-2">
          <span className="w-9 h-9 rounded-xl bg-gradient-primary text-white flex items-center justify-center font-extrabold">
            G
          </span>
            ...
            {links.map(([t, h]) => (
              <li key={h}>
                <a
                  ...
                  className="block py-2.5 px-3 rounded-lg hover:bg-secondary text-foreground"
                >
                  {t}
                </a>
              </li>
...
function QuantitySelector() {
  ...
  return (
    <div className="flex items-center rounded-xl border border-border overflow-hidden">
      ...
      <button onClick={() => setQ((x) => x + 1)} className="px-3 py-2 hover:bg-secondary">
        +
      </button>
    </div>
  );
...
const QUESTIONS = [
  {
    q: "الگوی اصلی دفع شما در بیشتر روزها چگونه است؟",
    opts: [
      "بیشتر اسهال",
      "بیشتر یبوست",
      "ترکیبی از اسهال و یبوست",
      "نرمال ولی همراه با درد یا نفخ",
    ],
  },
  {
    q: "آیا پزشک قبلا برای شما IBD، کرون یا کولیت تشخیص داده است؟",
    opts: [
      "بله، کرون",
      "بله، کولیت اولسراتیو",
      "بله، IBD ولی نوع دقیق را نمی‌دانم",
      "خیر / مطمئن نیستم",
    ],
  },
  {
    q: "کدام مورد بیشتر با تجربه شما نزدیک است؟",
    opts: [
      "درد شکمی و اسهال مکرر",
      "یبوست و نفخ",
      "تغییرات متناوب بین اسهال و یبوست",
      "التهاب یا بیماری گوارشی تاییدشده توسط پزشک",
    ],
  },
  {
    q: "هدف اصلی شما از استفاده از دمنوش چیست؟",
    opts: [
      "آرامش گوارشی روزانه",
      "کاهش حس نفخ و سنگینی",
      "همراهی با رژیم مراقبت گوارشی",
      "انتخاب محصول مناسب‌تر بر اساس شرایطم",
    ],
  },
];
    ...
    <div className="mt-4 rounded-2xl border border-border bg-white p-5 shadow-card fade-in">
      ...
      {isQuestionStep ? (
        ...
        <div>
          <label className="font-bold text-foreground block">
            برای دریافت نتیجه و مشاوره انتخاب محصول، شماره تماس خود را وارد کنید.
          </label>
          <input
            value={phone}
      ...
      <div className="mt-5 flex items-center justify-between gap-3">
        ...
        {step < total ? (
          ...
          <button
            onClick={onSubmit}
            className="rounded-xl px-5 py-2.5 text-sm font-semibold bg-gradient-primary text-white"
          >
...
function AnyarSection({ v1, v2 }: { v1: string; v2: string }) {
  const videos = [
    {
      thumb: v1,
      title: "چطور علائم گوارشی خود را بهتر بشناسیم؟",
      desc: "نکاتی ساده برای شناخت بهتر سبک زندگی گوارشی.",
    },
    {
      thumb: v2,
      title: "اشتباهات رایج در مصرف دمنوش‌ها و مکمل‌های گیاهی",
      desc: "آنچه باید پیش از مصرف بدانید.",
    },
  ];
  return (
...
const FAQS = [
  {
    q: "Grenz چه زمانی اثر خود را نشان می‌دهد؟",
    a: "تجربه افراد متفاوت است. Grenz با هدف همراهی در روتین آرامش گوارشی طراحی شده و زمان احساس تغییر می‌تواند بسته به سبک زندگی، تغذیه و شرایط بدن متفاوت باشد.",
  },
  {
    q: "آیا Grenz تداخل دارویی دارد؟",
    a: "اگر دارو مصرف می‌کنید، بیماری زمینه‌ای دارید، باردار هستید یا تحت درمان پزشک هستید، قبل از مصرف هر دمنوش یا محصول گیاهی با پزشک یا داروساز مشورت کنید.",
  },
  {
    q: "آیا Grenz عوارض دارد؟",
    a: "ترکیبات گیاهی نیز ممکن است برای برخی افراد حساسیت یا ناسازگاری ایجاد کنند. در صورت بروز واکنش غیرعادی، مصرف را قطع کرده و با پزشک مشورت کنید.",
  },
  {
    q: "Grenz مناسب چه افرادی نیست؟",
    a: "افراد باردار یا شیرده، کودکان، افراد دارای بیماری زمینه‌ای جدی، کسانی که داروهای خاص مصرف می‌کنند، یا افراد دارای حساسیت به ترکیبات گیاهی باید قبل از مصرف با پزشک مشورت کنند.",
  },
];
    ...
    <section id="faq" className="px-5 py-14 bg-secondary/40">
      <div className="mx-auto max-w-3xl">
        <SectionTitle
          kicker="پرسش و پاسخ"
          title="سوالات متداول"
          desc="پاسخ سوالات رایج درباره Grenz و مصرف آن."
        />
          ...
          {FAQS.map((f, i) => (
            <div key={i} className="rounded-2xl bg-white border border-border overflow-hidden">
              ...
              >
                ...
                <ChevronDown
                  className={`w-5 h-5 text-primary-deep transition ${open === i ? "rotate-180" : ""}`}
                />
              </button>
              {open === i && (
                <div className="px-4 pb-5 text-sm text-muted-foreground leading-7">{f.a}</div>
              )}
            </div>
          ))}
        </div>
...
const TESTIMONIALS = [
  {
    name: "نگار، تهران",
    rating: 5,
    text: "بعد از چند روز استفاده، حس آرامش بیشتری در روتین گوارشی‌ام داشتم.",
  },
  {
    name: "علی، اصفهان",
    rating: 5,
    text: "بسته‌بندی، طعم و راهنمای انتخاب محصول برایم قابل اعتماد بود.",
  },
  ...
  return (
    <section id="reviews" className="px-5 py-14 bg-white">
      <div className="mx-auto max-w-5xl">
        <SectionTitle
          kicker="رضایت مشتریان"
          title="تجربه مصرف‌کنندگان Grenz"
          desc="بخشی از بازخوردهای واقعی کاربران ما."
        />
            ...
            <div key={t.name} className="rounded-2xl border border-border bg-white p-5 shadow-card">
              <div className="flex items-center gap-1 text-primary">
                {Array.from({ length: 5 }).map((_, i) => (
                  <Star
                    key={i}
                    className={`w-4 h-4 ${i < t.rating ? "fill-primary" : "opacity-30"}`}
                  />
                ))}
              </div>
      ...
      <div className="mx-auto max-w-5xl grid md:grid-cols-3 gap-8">
        <div>
          <div className="flex items-center gap-2">
            <span className="w-9 h-9 rounded-xl bg-white text-primary-deep flex items-center justify-center font-extrabold">
              G
            </span>
            <span className="font-extrabold tracking-tight">Grenz</span>
          </div>
          <p className="mt-3 text-sm text-white/80 leading-7">
            Grenz یک برند سلامت‌محور در حوزه دمنوش‌های گیاهی است که با تمرکز بر سادگی، آرامش و
            انتخاب آگاهانه طراحی شده است.
          </p>
          <p className="mt-4 text-sm flex items-center gap-2">
            <Phone className="w-4 h-4" /> پشتیبانی: <a href="tel:+982122223410">۰۲۱-۲۲۲۲۳۴۱۰</a>
          </p>
    ...
    <div className="fixed bottom-0 inset-x-0 z-40 px-3 pb-3">
      <div className="mx-auto max-w-3xl rounded-2xl bg-white/95 backdrop-blur shadow-soft border border-border p-3 flex items-center gap-3">
        <p className="flex-1 text-xs sm:text-sm text-foreground leading-5">
          {unlocked ? "" : "برای مشاهده محصول پیشنهادی، ابتدا وضعیت گوارشی خود را انتخاب کنید"}
        </p>
        {unlocked ? (
          <button
            onClick={onBuy}
            className="rounded-xl bg-gradient-primary text-white text-sm font-bold px-4 py-2.5 active:scale-[.98] w-full "
          >
            افزودن به سبد خرید
          </button>
        ) : (
          <button
            onClick={onPick}
            className="rounded-xl bg-gradient-primary text-white text-sm font-bold px-4 py-2.5 active:scale-[.98] w-35"
          >
            شروع انتخاب
          </button>
        )}
